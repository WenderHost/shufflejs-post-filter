...
class PostFilters {
  constructor(){
    ...
    if( 0 < this.subCategoryArray.length || 0 < this.certificationArray.length )
      this.deepLink()
  }
    ...
    switch( this.postType ){
      ...
      default:
        ...
        if( 'newsletter_form' == el.title ){
          listItem = `<li class="list-item ${this.postType} newsletter-signup" data-groups="[]"><div class="list-content ${this.postType}">[NEWSLETTER SIGN UP GOES HERE.]</div></li>`
        }
        post = listItem
    }
    return post
