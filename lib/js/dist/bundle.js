      ...
      switch (this.postType) {
        ...
        default:
          ...
          if ('newsletter_form' == el.title) {
            listItem = "<li class=\"list-item ".concat(this.postType, " newsletter-signup\" data-groups=\"[]\"><div class=\"list-content ").concat(this.postType, "\">[NEWSLETTER SIGN UP GOES HERE.]</div></li>");
          }
