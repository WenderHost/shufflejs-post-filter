...
class PostFilters {
  ...
  _getPostElement( el ){
    ...
    switch( this.postType ){
      case 'product':
        post = '<li class="list-item ' + this.postType + '" data-groups=\'' + el.css_classes + '\'><div class="list-content ' + this.postType + '"><h3><a href="' + el.permalink + '">' + truncate( el.title, 50, true ) + '</a></h3><div><a class="button" href="' + el.permalink + '">View the Course</a></div></div></li>'
        break

      default:
        post = '<li class="list-item ' + this.postType + '" data-groups=\'' + el.css_classes + '\'><div class="list-content ' + this.postType + '"><div class="overlay"><img src="' + thumbnailUrl + '" alt="' + el.esc_title + '" /></div><p class="meta">' + el.meta + '</p><h3><a href="' + el.permalink + '">' + truncate( el.title, 80, true ) + '</a></h3></div></li>'
    }
    return post
  }
}
