...
const mobileBreakPoint = postFilterVars.mobileBreakPoint
...
class PostFilters {
  constructor(){
    ...
    const allPosts = postFilterVars.posts
  ...
  _getPostElement( el ){
    ...
    switch( this.postType ){
                  ...
                  <div class="course-meta">
                    ...
                    <div class="course-meta-row">
                      <div class="course-meta-col ${el.meta.face_to_face}">
                        ...
                        <div class="text">${postFilterVars.labels.faceToFace}</div>
                      </div>
      ...
      default:
        ...
        let listItem = `<li class="list-item ${postFilterVars.category} ${this.postType}" data-groups='${JSON.stringify(el.groups)}'><a href="${el.permalink}"><div class="list-content ${this.postType}">${overlay}${meta}${title}</div></a></li>`
        if( 'newsletter_form' == el.title ){
          listItem = `<li class="list-item ${this.postType} newsletter-signup" data-groups="[]"><div class="list-content ${this.postType}">${postFilterVars.newsletterForm}</div></li>`
        }
        post = listItem
    }
    return post
