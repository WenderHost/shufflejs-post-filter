...
},{"./shufflejs-init":2,"@babel/runtime/helpers/interopRequireDefault":7}],2:[function(require,module,exports){
"use strict";
    ...
    */
    ...
    value: function _getPostElement(el) {
      ...
      switch (this.postType) {
        case 'product':
          post = '<li class="list-item ' + this.postType + '" data-groups=\'' + JSON.stringify(el.groups) + '\'><div class="list-content ' + this.postType + '"><h3><a href="' + el.permalink + '">' + (0, _utilities.truncate)(el.title, 50, true) + '</a></h3><div><a class="button" href="' + el.permalink + '">View the Course</a></div></div></li>';
          break;

        default:
          post = '<li class="list-item ' + this.postType + '" data-groups=\'' + JSON.stringify(el.groups) + '\'><div class="list-content ' + this.postType + '"><div class="overlay"><img src="' + thumbnailUrl + '" alt="' + el.esc_title + '" /></div><p class="meta">' + el.meta + '</p><h3><a href="' + el.permalink + '">' + (0, _utilities.truncate)(el.title, 80, true) + '</a></h3></div></li>';
      }
...
},{"./utilities":3,"@babel/runtime/helpers/classCallCheck":5,"@babel/runtime/helpers/createClass":6,"@babel/runtime/helpers/interopRequireDefault":7,"@babel/runtime/helpers/slicedToArray":10,"shufflejs":11}],3:[function(require,module,exports){
"use strict";
...
},{"./arrayWithHoles":4,"./iterableToArrayLimit":8,"./nonIterableRest":9}],11:[function(require,module,exports){
