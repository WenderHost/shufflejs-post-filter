  ...
  _getPostElement( el ){
    ...
    switch( this.postType ){
      case 'product':
        ...
        if( typeof el.meta._course_delivery_mode !== 'undefined' )
          virtualCourse = ( -1 < el.meta._course_delivery_mode[0].indexOf('Virtual') )? true : false

        var faceToFaceCourse = true
        if( typeof el.meta._course_delivery_mode !== 'undefined' )
          faceToFaceCourse = ( -1 < el.meta._course_delivery_mode[0].indexOf('Face-to-Face') )? true : false
        ...
        post = `
        <li class="list-item ${this.postType}" data-groups="${dataGroups}">
          <a href="${el.permalink}">
            <div class="flip-card">
                  ...
                  <div class="course-meta">
                    <div class="course-meta-row">
                      <div class="course-meta-col">
                        ...
                        <div class="text">${el.meta._course_duration[0]}</div>
                      </div>
                      <div class="course-meta-col">
                        <div class="text">${el.meta._course_reference[0]}</div>
                      </div>
                    </div>
                    <div class="course-meta-row">
                      <div class="course-meta-col ${faceToFaceCourse}">
                        <div class="icon face-to-face ${faceToFaceCourse}"></div>
                        <div class="text">Face-to-Face</div>
                      </div>
                      <div class="course-meta-col ${virtualCourse}">
                        <div class="icon virtual ${virtualCourse}"></div>
