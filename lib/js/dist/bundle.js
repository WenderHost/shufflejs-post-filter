...
var PostFilters = /*#__PURE__*/function () {
  function PostFilters() {
    ...
    } //console.log(`this.certificationArray = `, this.certificationArray)
  ...
  (0, _createClass2["default"])(PostFilters, [{
    ...
    value: function deepLink() {
      ...
      document.getElementById('shuffle-filters').scrollIntoView({
        behavior: 'smooth'
      });
      /**/
      //document.getElementById('shuffle-filters').scrollTop -= 30;
    ...
    value: function loadPosts() {
      ...
      posts.forEach(function (el, index, array) {
        ...
        if (elProcessed === array.length) {
          console.log('Shuffling now! this.page_number = ', _this5.page_number);
